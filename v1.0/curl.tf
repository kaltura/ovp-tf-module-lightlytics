          ...
          -d '{
                ...
                "variables": {
                  "input": {
                    ...
                    "role_arn":"arn:aws:iam::"${var.account_id}":role/"${var.env_name_prefix}-lightlytics-role"",
                    "account_type":"AWS","account_aliases":"","aws_account_id":"${var.account_id}","stack_region":"${var.aws_region}",
